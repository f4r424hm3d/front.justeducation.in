...
const SchoolPage: React.FC = () => {
  ...
  const schools = [
    ...
    },
    {
      ...
      information:
        "The Doon School is one of India's most elite boarding schools, established in 1935 in Dehradun. Known for its rigorous academic program and emphasis on character development, the school has produced numerous leaders in politics, business, and public service. The Doon School offers a comprehensive education with excellent facilities including spacious dormitories, well-equipped classrooms, extensive sports facilities, and beautiful campus grounds. The school follows a unique house system that fosters leadership, teamwork, and healthy competition among students. Admission to Doon School is highly competitive and considered a mark of academic and social distinction.",
    },
    {
      id: 3,
  ...
  const displayedLocations = showMoreLocations
    ? filteredLocations
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await api.get<ApiResponse<Currentschool[]>>(
          `/organizations-by-category/${slug}`
        );
    ...
    <MainLayout>
      <div className="min-h-screen bg-gray-50">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('https://img.freepik.com/premium-photo/star-universe-galaxy-astrology-background_78899-4653.jpg?semt=ais_hybrid&w=740')",
        ...
        >
          <div className="container mx-auto px-4 relative z-10">
            ...
            <p className="text-lg md:text-xl mb-6">
              Explore top schools across India and choose the right one for your
              child's future
            </p>
            {/* Search Bar */}
              ...
              <div className="bg-white rounded-lg shadow-md p-4 sticky top-6">
                        ...
                        {filteredLocations.length > 8 && (
                          <div className="p-2">
                            ...
                            >
                              {showMoreLocations
                                ? "Show Less"
                                : `+ ${filteredLocations.length - 8} More`}
                            </button>
                          </div>
                        )}
                      </div>
                    ...
                    <div className="mt-1 bg-white">
                      <div className="max-h-60 overflow-y-auto">
                        {classOptions.map((classItem) => (
                          <div
                            key={classItem.name}
                            className="flex items-center justify-between py-1.5 px-2 hover:bg-gray-50"
                          >
                ...
                <div className="mb-2">
                  <div
                    className="flex items-center justify-between cursor-pointer p-3 bg-white rounded-lg hover:bg-gray-50 shadow-sm"
                    onClick={() =>
                      setAdmissionStatusExpanded(!admissionStatusExpanded)
                    }
                  >
                    <span className="text-sm font-medium text-gray-700">
                        ...
                        {admissionStatusOptions.map((status) => (
                          ...
                          >
                            <input
                              ...
                              onChange={() =>
                                handleAdmissionStatusChange(status)
                              }
                              className="mr-2 text-green-600 focus:ring-green-500 scale-75"
                            />
                            <label
                          ...
                          >
                            <div className="flex items-center flex-1">
                              <input
                                ...
                                name="ownership"
                                checked={selectedOwnership.includes(
                                  ownership.name
                                )}
                                onChange={() =>
                                  handleOwnershipChange(ownership.name)
                                }
                                className="mr-2 text-green-600 focus:ring-green-500 scale-75"
                              />
                              <label
                          ...
                          >
                            <div className="flex items-center flex-1">
                              <input
                                ...
                                onChange={() =>
                                  handleSchoolTypeChange(type.name)
                                }
                                className="mr-2 text-green-600 focus:ring-green-500 scale-75"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-4">
                  {school.map((school) => (
                    ...
                    >
                      {/* Top Rated Badge */}
                      {school.rating >= 4.6 && (
                        <span className="absolute top-2 left-2 z-10 bg-green-500 text-white text-xs font-bold px-2 py-0.5 rounded-full shadow-sm group-hover:bg-green-600 transition">
                          Top Rated
                        </span>
                      )}
                      ...
                      <div className="p-3 flex flex-col flex-grow">
                        ...
                        <div className="mb-3 flex-grow">
                          <p className="text-xs text-gray-600 leading-relaxed">
                            {school.information ||
                              "School is a place where students learn and grow, both academically and socially."}

                            <button
                              onClick={(e) =>
                                handleViewDetails(e, school.organization_slug)
                              }
